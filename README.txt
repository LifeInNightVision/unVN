...
Arrow Keys:    		Selects menu choices, buttons, and sliders.
...
Mousewheel-Down, PageDown: Causes rollforward to occur, cancelling out a previous rollback.
...
Alt-H, Command-H:    	Hides (iconifies) the window.
